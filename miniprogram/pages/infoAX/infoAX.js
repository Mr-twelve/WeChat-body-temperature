...
Page({
  ...
  data: {
    ifmathbanjitotal:false,
    ifmathbanjitotalb: false,
        ...
        db.collection('YS').where({
          ...
          db.collection('YS').where({
            ...
            db.collection('TJ').where({
              ...
              switch (res.data.QX) {
                case "13":
                  var lsjl = resS.data[0].j13.reverse()
                  break;
                case "14":
                  var lsjl = resS.data[0].j14.reverse()
                  break;
                case "15":
                  var lsjl = resS.data[0].j15.reverse()
                  break;
                case "16":
                  var lsjl = resS.data[0].j16.reverse()
                  break;
                case "17":
                  var lsjl = resS.data[0].j17.reverse()
                  break;
                case "18":
                  var lsjl = resS.data[0].j18.reverse()
                  break;
                case "19":
                  var lsjl = resS.data[0].j19.reverse()
                  break;
              }
              self.setData({
                nianji: res.data.QX, //年级
                ...
                .end({
                  success: function (mathb) {
                    ...
                    self.setData({
                      tapeople: resa.total,
                      tbpeople: resb.total,
                      mathbanjitotal: math.list,
                      mathbanjitotalb: mathb.list
                    })
  ...
  savaExcel(userdata) {
    ...
    wx.cloud.callFunction({
      name: "Excel",
      data: {
        name: that.data.xueyuan + that.data.nianji + '级历史异常人数汇总',
        userdata: userdata
      },
      success(res) {
  ...
  showifmathbanjitotal(e){
    this.setData({
      ifmathbanjitotal: true
    })
  },
  hideifmathbanjitotal(e) {
    this.setData({
      ifmathbanjitotal: false
    })
  },
  showifmathbanjitotalb(e) {
    this.setData({
      ifmathbanjitotalb: true
    })
  },
  hideifmathbanjitotalb(e) {
    this.setData({
      ifmathbanjitotalb: false
    })
  },
